...
// Deploy contract
const Project = await ethers.getContractFactory("Project");
const project = await Project.deploy(owner.address);

// Mint a new character
await project.mintCharacter(
    playerAddress,
    "Dragon Slayer",
    [75, 60, 85] // [strength, agility, intelligence]
);

// Engage in battle
const [attackerWins, expGained] = await project.engageBattle(
    attackerTokenId, 
    defenderTokenId
);

// Update character after gameplay
await project.updateCharacterStats(
    tokenId,
